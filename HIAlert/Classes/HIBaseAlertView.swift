...
/// alertView 样式
public enum HIBaseAlertViewStyle {
    case apple,
    custom
}

/// 按钮排列方式 只有两个按钮时生效
public enum HIButtonArrangementMode {
    case horizontal,
    vertical
}

open class HIBaseAlertView: UIView {
    
    /// 标题 /Tilte
    public var titleLabel: UILabel!
    /// 内容 可以设置字体颜色 大小 对齐方式 /Messsage
    public var messageTextView: HIAlertTextView!
    ...
    public var alertStyle: HIBaseAlertViewStyle = .apple
...
extension HIBaseAlertView {
    ...
    private func initSubviews() {
        ...
        messageTextView = HIAlertTextView(frame: CGRect.zero)
...
open class HIAlertTextView: UITextView {
