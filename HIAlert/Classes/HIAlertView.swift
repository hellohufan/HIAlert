...
/// style
public enum HIAlertViewStyle {
    case defaulted,
    textField
}

open class HIAlertView: UIView {
    ...
    public convenience init(style: HIAlertViewStyle) {
        self.init(style: style, title: nil, message: nil)
    }
    
    public init(style: HIAlertViewStyle, title: String?, message: String?) {
